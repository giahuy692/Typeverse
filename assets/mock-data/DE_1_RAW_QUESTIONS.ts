export const DE_1_RAW_QUESTIONS = [
  {
    id: 36,
    skill_id: 3,
    type: 1,
    ...
    childs: [
      {
        ...
        audio_url:
          '/storage/exam/mp3/lCeBInwPOb87t82bABtKQoj6tLJLjpsu4yyGVSCh.mp3',
        answer: [
          {
      ...
      },
      {
        ...
        audio_url:
          '/storage/exam/mp3/ZRzOWW9tQuKgna7z7Ti0ixY45g801eOGUNVOPWuQ.mp3',
        answer: [
          {
            answer: 'Horse riding',
            correct: 0,
      ...
      },
      {
        ...
        audio_url:
          '/storage/exam/mp3/QfHPe142wP4VJ9avOoOPZcWiRyhQoUX0ZpEsdDxj.mp3',
        answer: [
          {
            answer: 'Mountain biking',
            correct: 0,
      ...
      },
      {
        ...
        audio_url:
          '/storage/exam/mp3/eo5dJq4L3HAFaWlw65eNCZsOeM6tuUcuVmWHEowK.mp3',
        answer: [
          {
            answer: 'Walking',
            correct: 0,
    ...
    childs: [
      {
        ...
        skill_id: 3,
        type: 3,
        title: 'There is too much information on the Internet',
        explain:
      ...
      },
      {
        ...
        skill_id: 3,
        type: 3,
        title: 'Finding information on the Internet requires skills',
        explain:
      ...
      },
      {
        ...
        skill_id: 3,
        type: 3,
        title: 'The use of internet affects the way we think',
        explain:
      ...
      },
      {
        ...
        skill_id: 3,
        type: 3,
        title: 'The internet makes young people less patient',
        explain:
